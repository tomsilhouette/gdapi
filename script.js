...
var CLIENT_ID = '802277692590-trtqsio7ub2kfqscd9vs5ifqfpkb1bhe.apps.googleusercontent.com';
var API_KEY = 'AIzaSyDo9xunfaUuo1VoHH39VIhYVMwVg4cWxDw';
...
function upload() {
    ...
    if (text.value != "") {
        ...
        // console.log('gapi.auth.getToken().access_token', gapi.auth.getToken().access_token);
